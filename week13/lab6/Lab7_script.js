...
// You want users to be able to click on a color button to change the background color of a display box (colorBox).
...
function colorChange(eventObj) {
    let clicked = eventObj.target;
    let btnColor = clicked.style.backgroundColor;
    colorBox.style.backgroundColor = btnColor;
}

colorButtons.addEventListener("click", colorChange);
